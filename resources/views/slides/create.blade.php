    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{url('/slide')}}" class="text-success"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
                <div class="card-block">
                    ...
                    >
                        ...
                        <div class="form-group row">
                            <label for="photo" class="control-label col-lg-2 col-sm-2">Image <span class="text-info" style="font-size:13px;">(1200 x 500)</span> <span class="text-danger">*</span></label>
                            <div class="col-lg-6 col-sm-8">
